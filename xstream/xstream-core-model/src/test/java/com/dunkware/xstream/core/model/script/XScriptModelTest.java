...
import com.dunkware.xstream.model.script.utils.XScriptModelUpdater;
import com.dunkware.xstream.model.script.utils.XScriptUpdate;
...
public class XScriptModelTest extends TestCase {

	@Test
	public void updaterTest() {
		XScriptModel model = new XScriptModel();
		XScriptModelUpdater updater = new XScriptModelUpdater(model);
		...
		updater = new XScriptModelUpdater(clonedModel);
