...
public class XStreamEntityValueType {

	private XStreamEntityValueKind type;
	...
	public XStreamEntityValueKind getType() {
		return type;
	}
	public void setType(XStreamEntityValueKind type) {
		this.type = type;
	}
