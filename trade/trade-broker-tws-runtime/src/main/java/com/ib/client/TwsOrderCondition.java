...
public abstract class TwsOrderCondition {

    private TwsOrderConditionType m_type;
    ...
    public TwsOrderConditionType type() {
        return m_type;
    }

    public static TwsOrderCondition create(TwsOrderConditionType type) {
        TwsOrderCondition orderCondition;
        switch (type) {
            case Execution:
