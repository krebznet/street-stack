...
public class AdjustedPanel extends OnOKPanel {
	...
	private final TCombo<TwsOrderType> m_adjustedOrderType = new TCombo<>(TwsOrderType.None, TwsOrderType.STP, TwsOrderType.STP_LMT, TwsOrderType.TRAIL, TwsOrderType.TRAIL_LIMIT);
	...
	public AdjustedPanel(JDialog parentDlg, TwsOrder order) {
