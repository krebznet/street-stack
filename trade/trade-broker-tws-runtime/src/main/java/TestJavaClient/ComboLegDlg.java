...
import com.ib.client.TwsOrderComboLeg;
...
public class ComboLegDlg extends JDialog {
	...
	private List<TwsOrderComboLeg> m_orderComboLegs;
    ...
    ComboLegDlg(List<ComboLeg> comboLegs, List<TwsOrderComboLeg> orderComboLegs, String orderExchange, JDialog owner) {
        super( owner, true);
...
class ComboLegModel extends AbstractTableModel {
    ...
    private List<TwsOrderComboLeg> m_orderComboLegData = new ArrayList<>();

    synchronized void addComboLeg( ComboLeg comboLeg, TwsOrderComboLeg orderComboLeg) {
    ...
    synchronized public Object getValueAt(int r, int c) {
        ...
        TwsOrderComboLeg orderComboLeg = m_orderComboLegData.get(r);
    ...
    List<TwsOrderComboLeg> orderComboLegData() {
