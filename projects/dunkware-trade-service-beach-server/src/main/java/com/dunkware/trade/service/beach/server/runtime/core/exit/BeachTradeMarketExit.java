package com.dunkware.trade.service.beach.server.runtime.core.exit;
...
public class BeachTradeMarketExit implements BeachTradeExit {
	...
	public void orderFilled(EOrderFilled event) { 
		...
		eventNode.event(new EBeachTradeExitComplete(this.trade, this));
	}
