...
@Entity(name = "BeachOrderDO")
@Table(name = "beach_order")
public class BeachOrderDO {
	...
	private List<BeachOrderExecDO> execs = new ArrayList<BeachOrderExecDO>();
	...
	public List<BeachOrderExecDO> getExecs() {
		return execs;
	}
	public void setExecs(List<BeachOrderExecDO> execs) {
		this.execs = execs;
	}
