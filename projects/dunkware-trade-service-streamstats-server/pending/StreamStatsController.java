...
import com.dunkware.trade.net.service.streamstats.server.statcache.StreamStatCache;
...
public class StreamStatsController implements DKafkaByteHandler2 {
	...
	@Autowired
	private StreamStatCacheService statsService; 
	...
	public StreamStatCacheService getStatsService() {
		return statsService;
		
	}
	
	public StreamStatCache getstreamStats(String streamIdent) throws Exception { 
		//return statsService.get(streamIdent);
		return null;
	}
