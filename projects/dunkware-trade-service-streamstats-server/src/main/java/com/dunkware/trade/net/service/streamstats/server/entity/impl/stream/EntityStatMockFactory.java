...
public class EntityStatMockFactory {

	public static List<EntityStat> build(EntityStatMockBean bean) { 
	...
	private static void buildDateStats(LocalDate date, List<EntityStat> stats, EntityStatMockBean bean) { 
		int entityCount = 0; 
		int entityId = 1;
	...
	private static void buildEntityStats(LocalDate date, List<EntityStat> stats, int entityId, EntityStatMockBean bean) { 
		// first vars; 
		int varCount = 0; 
		int varId = 1; 
	...
	private static void buildEntityVarStats(LocalDate date, List<EntityStat> stats, int entityId, int varId,EntityStatMockBean bean) { 
		int statCount = 0; 
		int statId = 1; 
	...
	private static void buildEntitySignalStats(LocalDate date, List<EntityStat> stats, int entityId, EntityStatMockBean bean) { 
		int signalCount = 0;
		int signalId = 1; 
