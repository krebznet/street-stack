...
public class EntityStatsSQLWriter {
	...
	public static EntityStatsSQLWriter newInstance(MySqlConnectionPool pool, int writeThread, String tableName) throws Exception { 
		return new EntityStatsSQLWriter(pool,writeThread,tableName);
	}

	public static EntityStatsSQLWriter newInstance(String dbHost, String dbName, int dbPort, String userName,
...
//	private BlockingQueue<EntityStatsInsertThread> completedThreads = new LinkedBlockingQueue<EntityStatsInsertThread>();
	...
	private EntityStatsSQLWriter(MySqlConnectionPool pool, int writeThreads, String tableName) throws Exception {
		this.pool = pool;
		this.writeThreads = 1;
		int i = 0;
