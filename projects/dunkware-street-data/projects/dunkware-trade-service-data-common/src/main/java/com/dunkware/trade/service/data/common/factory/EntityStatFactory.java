...
public class EntityStatFactory {

	public static List<EntityStat> build(EntityStatFactoryInput bean) { 
	...
	private static void buildDateStats(LocalDate date, List<EntityStat> stats, EntityStatFactoryInput bean) { 
		int entityCount = 0; 
		int entityId = 1;
	...
	private static void buildEntityStats(LocalDate date, List<EntityStat> stats, int entityId, EntityStatFactoryInput bean) { 
		// first vars; 
		int varCount = 0; 
		int varId = 1; 
	...
	private static void buildEntityVarStats(LocalDate date, List<EntityStat> stats, int entityId, int varId,EntityStatFactoryInput bean) { 
		int statCount = 0; 
		int statId = 1; 
	...
	private static void buildEntitySignalStats(LocalDate date, List<EntityStat> stats, int entityId, EntityStatFactoryInput bean) { 
		int signalCount = 0;
		int signalId = 1; 
