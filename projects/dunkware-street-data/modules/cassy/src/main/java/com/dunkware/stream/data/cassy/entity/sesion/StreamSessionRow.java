...
public class StreamSessionRow {
    ...
    public StreamSessionRow() {
    }

    public StreamSessionRow(StreamSessionKey key, List<Integer> vars, List<Integer> signals, List<Integer> stats, List<Integer> entities, LocalTime start, LocalTime stop) {
        this.key = key;
        this.vars = vars;
    ...
    public StreamSessionKey getKey() {
        return key;
    }

    public void setKey(StreamSessionKey key) {
        this.key = key;
    }
