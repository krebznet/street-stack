...
public class DunkTime {
	...
	public static void main(String[] args) {
			LocalDate now = LocalDate.now(DTimeZone.toZoneId(DTimeZone.NewYork));
			LocalTime time = LocalTime.of(0,1,1);
			LocalDateTime newTime = LocalDateTime.of(now, time);
			String isoString = newTime.format(DateTimeFormatter.ISO_DATE_TIME);
