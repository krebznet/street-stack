...
import com.dunkware.utils.tick.reactor.blueprint.updater.IncrementUpdaterType;
import com.dunkware.utils.tick.reactor.blueprint.updater.TimeUpdaterType;
import com.dunkware.utils.tick.stream.TickStream;
import com.dunkware.utils.tick.stream.TickStreamFactory;
import com.dunkware.utils.tick.stream.impl.strategies.TickReactorDefaultStrategy;
import com.dunkware.utils.tick.stream.impl.updaters.TickReactorIncrementUpdater;
import com.dunkware.utils.tick.stream.impl.updaters.TickReactorTimeUpdater;
...
public class TickReactor {
	...
	private void setup() throws TickReactorException {
		// create the ticksets
		tickRouter = TickStreamFactory.newStream();
