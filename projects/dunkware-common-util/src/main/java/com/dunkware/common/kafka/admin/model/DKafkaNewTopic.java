...
public class DKafkaNewTopic {
	...
	public static class Builder {
		...
		public DKafkaNewTopic build() {
			...
			return new DKafkaNewTopic(topic, configs);
		}
	...
	public DKafkaNewTopic(NewTopic topic, Map<String, String> configs) {
		this.topic = topic;
