...
public class SessionEntityStatRow {
    ...
    public SessionEntityStatRow() {
    }

    public SessionEntityStatRow(SessionEntityStatKey key, int element, double value, LocalTime time) {
        this.key = key;
    ...
    public SessionEntityStatKey getKey() {
        return key;
    }

    public void setKey(SessionEntityStatKey key) {
        this.key = key;
        this.stream = key.getStream();
        this.date = key.getDate();
    }
