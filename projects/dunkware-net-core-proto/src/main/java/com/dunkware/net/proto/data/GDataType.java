...
/**
 * Protobuf enum {@code dunkware.data.GDataType}
 */
public enum GDataType
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return com.dunkware.net.proto.data.GDataProto.getDescriptor().getEnumTypes().get(5);
  }
  ...
  // @@protoc_insertion_point(enum_scope:dunkware.data.GDataType)
}
