...
public class XScriptParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XScriptGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSessionSignalExpressionTypeAccess().getOpAlternatives_4_0(), "rule__SessionSignalExpressionType__OpAlternatives_4_0");
			...
			builder.put(grammarAccess.getXValueSessionVarValueTypeAccess().getGroup(), "rule__XValueSessionVarValueType__Group__0");
			builder.put(grammarAccess.getXValueSessionVarAggTypeAccess().getGroup(), "rule__XValueSessionVarAggType__Group__0");
			builder.put(grammarAccess.getXValueSessionSignalCountTypeAccess().getGroup(), "rule__XValueSessionSignalCountType__Group__0");
			builder.put(grammarAccess.getXValueHistoricalVarAggTypeAccess().getGroup(), "rule__XValueHistoricalVarAggType__Group__0");
			builder.put(grammarAccess.getXValueHistoricalSignalCountTypeAccess().getGroup(), "rule__XValueHistoricalSignalCountType__Group__0");
			...
			builder.put(grammarAccess.getVarTypeAccess().getTypeAssignment_5(), "rule__VarType__TypeAssignment_5");
			builder.put(grammarAccess.getVarTypeAccess().getExpressionAssignment_8(), "rule__VarType__ExpressionAssignment_8");
			...
			builder.put(grammarAccess.getSessionSignalExpressionTypeAccess().getSignalAssignment_3(), "rule__SessionSignalExpressionType__SignalAssignment_3");
			builder.put(grammarAccess.getSessionSignalExpressionTypeAccess().getOpAssignment_4(), "rule__SessionSignalExpressionType__OpAssignment_4");
			...
			builder.put(grammarAccess.getXValueSessionVarValueTypeAccess().getVarAssignment_3(), "rule__XValueSessionVarValueType__VarAssignment_3");
			builder.put(grammarAccess.getXValueSessionVarValueTypeAccess().getIndexAssignment_5(), "rule__XValueSessionVarValueType__IndexAssignment_5");
			builder.put(grammarAccess.getXValueSessionVarAggTypeAccess().getVarAssignment_3(), "rule__XValueSessionVarAggType__VarAssignment_3");
			builder.put(grammarAccess.getXValueSessionVarAggTypeAccess().getFunctionAssignment_5(), "rule__XValueSessionVarAggType__FunctionAssignment_5");
			builder.put(grammarAccess.getXValueSessionVarAggTypeAccess().getRangeAssignment_7(), "rule__XValueSessionVarAggType__RangeAssignment_7");
			builder.put(grammarAccess.getXValueSessionSignalCountTypeAccess().getSignalAssignment_3(), "rule__XValueSessionSignalCountType__SignalAssignment_3");
			builder.put(grammarAccess.getXValueSessionSignalCountTypeAccess().getTimeRangeAssignment_5(), "rule__XValueSessionSignalCountType__TimeRangeAssignment_5");
			builder.put(grammarAccess.getXValueSessionSignalCountTypeAccess().getValueAssignment_7(), "rule__XValueSessionSignalCountType__ValueAssignment_7");
			builder.put(grammarAccess.getXValueHistoricalVarAggTypeAccess().getVarAssignment_2(), "rule__XValueHistoricalVarAggType__VarAssignment_2");
			builder.put(grammarAccess.getXValueHistoricalVarAggTypeAccess().getFunctionAssignment_4(), "rule__XValueHistoricalVarAggType__FunctionAssignment_4");
			builder.put(grammarAccess.getXValueHistoricalVarAggTypeAccess().getDaysAssignment_6(), "rule__XValueHistoricalVarAggType__DaysAssignment_6");
			builder.put(grammarAccess.getXValueHistoricalSignalCountTypeAccess().getSignalAssignment_3(), "rule__XValueHistoricalSignalCountType__SignalAssignment_3");
			builder.put(grammarAccess.getXValueHistoricalSignalCountTypeAccess().getDaysAssignment_5(), "rule__XValueHistoricalSignalCountType__DaysAssignment_5");
