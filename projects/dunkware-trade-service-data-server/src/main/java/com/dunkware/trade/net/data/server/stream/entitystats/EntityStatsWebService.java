...
import com.dunkware.trade.net.data.server.stream.entitystats.impl.EntityStatMockBean;
import com.dunkware.trade.net.data.server.stream.entitystats.impl.EntityStatMockFactory;
...
public class EntityStatsWebService {
	...
	@GetMapping(path = "/data/v1/entity/stats/bean")
	...
	@GetMapping(path = "/data/v1/entity/stats/mock/insert")
