...
public class SessionMongoSignalWriter implements DKafkaByteHandler2 {
	...
	public StreamSessionSignalWriterStats getStats() { 
		StreamSessionSignalWriterStats stats = new StreamSessionSignalWriterStats();
		stats.setConsumeCount(this.signalConsumeCount.get());
		stats.setWriteCount(this.signalWriteCount.get());
		stats.setLastWriteSize(lastSignalWriteSize);
		stats.setLastWriteTime(lastSignalWriteTime);
		return stats;
	}
	@Override
