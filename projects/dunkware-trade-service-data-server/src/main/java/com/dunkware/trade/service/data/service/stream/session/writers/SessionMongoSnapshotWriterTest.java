...
public class SessionMongoSnapshotWriterTest {
	
	public static void main(String[] args) {
		
		try {
			SessionMongoSnapshotWriterInput input = new SessionMongoSnapshotWriterInput();
			...
			SessionMongoSnapshotWriter capture = new SessionMongoSnapshotWriter();
			capture.start(input);
		} catch (Exception e) {
