package com.dunkware.trade.service.data.util.aggregation;
...
public class GetMinMaxVars {
	...
	private void test1() {
		try {
			...
			List<Document> results = collection.get().aggregate(Arrays.asList(match, group)).into(new ArrayList<>());
