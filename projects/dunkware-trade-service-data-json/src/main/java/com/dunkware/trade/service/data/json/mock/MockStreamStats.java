...
public class MockStreamStats {
	...
	private MockStreamSessionStats session = null;
	...
	public MockStreamSessionStats getSession() {
		return session;
	}


	public void setSession(MockStreamSessionStats session) {
