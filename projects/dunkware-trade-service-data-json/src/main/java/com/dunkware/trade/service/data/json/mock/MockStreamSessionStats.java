...
public class MockStreamSessionStats {
	...
	private StreamSessionState getState; 
	...
	public StreamSessionState getGetState() {
		return getState;
	}
	public void setGetState(StreamSessionState getState) {
