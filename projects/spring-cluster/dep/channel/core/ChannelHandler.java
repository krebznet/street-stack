...
import com.dunkware.spring.messaging.channel.anot.AChannelSetter;
import com.dunkware.spring.messaging.channel.anot.AMessageHandler;
import com.dunkware.spring.messaging.channel.anot.ARequestHandler;
...
public class ChannelHandler {
	...
	public ChannelHandler(Object target, Channel channel) throws ChannelException {
		...
		List<Method> replyMethods = DAnotHelper.getMethodsAnnotatedWith(target.getClass(), ARequestHandler.class);
