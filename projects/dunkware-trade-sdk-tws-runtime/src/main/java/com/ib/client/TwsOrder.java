...
public class TwsOrder {
    ...
    private List<TwsOrderComboLeg>  m_orderComboLegs = new ArrayList<>();
	...
	private TwsOrderType m_adjustedOrderType;
	...
	private List<TwsOrderCondition> m_conditions = new ArrayList<>();
    ...
    public TwsOrderType orderType()                    { return TwsOrderType.get(m_orderType); }
    ...
    public TwsOrderType deltaNeutralOrderType()        { return TwsOrderType.get(m_deltaNeutralOrderType); }
    public String getDeltaNeutralOrderType()        { return m_deltaNeutralOrderType; }
    public List<TwsOrderComboLeg> orderComboLegs()     { return m_orderComboLegs; }
	...
	public TwsOrderType adjustedOrderType()            { return m_adjustedOrderType; }
	...
	public List<TwsOrderCondition> conditions()        { return m_conditions; }
    ...
    public void deltaNeutralOrderType(TwsOrderType v)                      { m_deltaNeutralOrderType = ( v == null ) ? null : v.getApiString(); }
    ...
    public void orderType(TwsOrderType v)                                  { m_orderType = ( v == null ) ? null : v.getApiString(); }
    ...
    public void orderComboLegs(List<TwsOrderComboLeg> v)                   { m_orderComboLegs = v; }
	...
	public void adjustedOrderType(TwsOrderType v)                          { m_adjustedOrderType = v; }
	...
	public void conditions(List<TwsOrderCondition> v)                      { m_conditions = v; }
    ...
    public boolean equals(Object p_other) {
        ...
        if (!(p_other instanceof TwsOrder)) {
            return false;
        }
        TwsOrder l_theOther = (TwsOrder)p_other;
