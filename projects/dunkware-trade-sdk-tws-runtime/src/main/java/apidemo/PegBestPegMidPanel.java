...
import com.ib.client.TwsOrderCondition;
...
public class PegBestPegMidPanel extends OnOKPanel {
    ...
    public PegBestPegMidPanel(JDialog parentDlg, TwsOrder order) {
        ...
        m_competeAgainstBestOffsetUpToMid.setSelected(m_order.competeAgainstBestOffset() == TwsOrder.COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID);
    ...
    public TwsOrderCondition onOK() {
        m_order.minTradeQty(m_minTradeQty.getInt());
        m_order.minCompeteSize(m_minCompeteSize.getInt());
        m_order.competeAgainstBestOffset(m_competeAgainstBestOffsetUpToMid.isSelected() ? TwsOrder.COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID : m_competeAgainstBestOffset.getDouble());
        m_order.minCompeteSize(m_minCompeteSize.getInt());
