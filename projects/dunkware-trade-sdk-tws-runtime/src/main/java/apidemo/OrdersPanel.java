...
public class OrdersPanel extends JPanel {
	...
	static class OrdersModel extends AbstractTableModel implements ILiveOrderHandler {
		...
		@Override public void openOrder(Contract contract, TwsOrder order, TwsOrderState orderState) {
		...
		protected boolean shouldAdd(Contract contract, TwsOrder order, TwsOrderState orderState) {
			return true;
		}
		...
		@Override public void orderStatus(int orderId, TwsOrderStatus status, Decimal filled, Decimal remaining, double avgFillPrice, int permId, int parentId, double lastFillPrice, int clientId, String whyHeld, double mktCapPrice) {
		...
		@Override public Object getValueAt(int row, int col) {
			...
			TwsOrder order = fullOrder.m_order;
			switch( col) {
	...
	static class OrderRow {
		Contract m_contract;
		TwsOrder m_order;
		TwsOrderState m_state;

		OrderRow( Contract contract, TwsOrder order, TwsOrderState state) {
			m_contract = contract;
			m_order = order;
			m_state = state;
		}
