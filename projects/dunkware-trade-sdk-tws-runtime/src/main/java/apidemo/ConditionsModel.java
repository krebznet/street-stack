...
public class ConditionsModel extends AbstractTableModel {
	...
	List<TwsOrderCondition> m_conditions;
	ContractLookuper m_lookuper;
	
	public ConditionsModel(List<TwsOrderCondition> conditions, ContractLookuper lookuper) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		if (columnIndex == 0) {
			TwsOrderCondition orderCondition = m_conditions.get(rowIndex);
