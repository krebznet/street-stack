...
public class ConditionsPanel extends OnOKPanel {
	...
	public ConditionsPanel(JDialog parentDlg, TwsOrder order, final ContractLookuper lookuper) {
		...
		buttons.add(new HtmlButton("Add") { @Override
			protected void actionPerformed() {
				ConditionDlg dlg = new ConditionDlg(TwsOrderCondition.create(TwsOrderConditionType.Price), lookuper);
