 ...
 * @date Dec 5, 2016
 */
public class IBTestWrapper implements EWrapper {
	...
	public void error(int id, int errorCode, String errorMsg) {
		System.err.println("error code " + errorMsg);
	}
	...
	@Override
	public void openOrder(int orderId, Contract contract, TwsOrder order,
