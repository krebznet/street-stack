...
public class TwsOrderComboLeg {
    ...
    public boolean equals(Object p_other) {
        ...
        if (!(p_other instanceof TwsOrderComboLeg)) {
            return false;
        }

        TwsOrderComboLeg l_theOther = (TwsOrderComboLeg)p_other;
