...
public class TwsOrderState {
    ...
    public TwsOrderStatus status()          { return TwsOrderStatus.get(m_status); }
    ...
    public void status(TwsOrderStatus v)          { m_status = ( v == null ) ? null : v.name(); }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TwsOrderState)) {
            return false;
        }
        TwsOrderState state = (TwsOrderState)other;
