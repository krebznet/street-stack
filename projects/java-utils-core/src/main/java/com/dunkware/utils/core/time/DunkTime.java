...
public class DunkTime {
    ...
    public static DunkTimeDuration dayDuration(ZoneId timeZone) {
    	LocalDateTime reference = LocalDateTime.now(timeZone);
    ...
    public static Date toDateWithOffset(LocalDateTime date, ZoneId zoneId) { 
