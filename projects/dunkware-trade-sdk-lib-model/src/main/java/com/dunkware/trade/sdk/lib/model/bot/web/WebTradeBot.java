...
import com.dunkware.trade.sdk.lib.model.bot.web.test.WebTradeBotSchedule;

public class WebTradeBot {
	...
	private List<WebTradeBotPlay> plays = new ArrayList<WebTradeBotPlay>();
	...
	public List<WebTradeBotPlay> getPlays() {
		return plays;
	}
	public void setPlays(List<WebTradeBotPlay> plays) {
		this.plays = plays;
	}
