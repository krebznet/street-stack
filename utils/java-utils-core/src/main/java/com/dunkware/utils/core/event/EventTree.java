...
public class EventTree {
	...
	public static EventTree newInstance(DunkExecutor executor)  {
		return new EventTree(executor);
	}
	...
	private EventTree(DunkExecutor executor) {
		rootNode = new EventNode(null, "/",this);
