...
import com.dunkware.trade.service.stream.serverd.controller.session.StreamSessionNodeStopState;
import com.dunkware.trade.service.stream.serverd.controller.session.events.EStreamSessionNodeKilled;
...
public class StreamSessionNodeImpl implements StreamSessionNode, DunkNetChannelHandler {
	...
	public void workerStats(StreamSessionWorkerStats stats) {
		...
		bean.setStats(stats.getDynamicStats());
		bean.notifyUpdate();
